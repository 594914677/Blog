layui.config({
    ...
    //监听提交
    form.on('submit(UpLinks)', function(data){
        var newsId = $(".id").val();
        ...
        $.post("linksUp",
            {newsId:newsId,linksName:linksName,linksUrl:linksUrl,masterEmail:masterEmail,linksDesc:linksDesc,linksTime:linksTime,isShow:isShow},
            function(res){
                if(res.status){
